class WinnerChecker {
    public static void checkWinner(int player1Points, int player2Points, String name1, String name2) {
        if(player1Points >= 3000 && player2Points >= 3000){
            ...
            System.out.println(System.lineSeparator() + "Both of the players reached above 3000 points, but ultimately, " + name1 + " won the game with a point difference of " + (player1Points - player2Points) + " points.");
            else
            System.out.println(System.lineSeparator() + "Both of the players reached above 3000 points, but ultimately, " + name2 + " won the game with a point difference of " + (player2Points - player1Points) + " points.");
        }
        else if (player1Points >= 3000){
